...
void demonstrateReviewSorting() {
    ...
    cout << "\n1. СОРТИРОВКА ПО РЕЙТИНГУ (высокий сначала):" << endl;
    ...
    cout << "\n2. СОРТИРОВКА ПО ДАТЕ (новые сначала):" << endl;
    ...
    cout << "\n4. ФИЛЬТРАЦИЯ ОТЗЫВОВ (рейтинг >= 4):" << endl;
    ...
    cout << "\n5. ПОИСК ОТЗЫВОВ (рейтинг = 5):" << endl;
...
void userOrderMode() {
    ...
    if (currentClient) {
        ...
        int loyaltyPoints = clientOrder->getCostOrder() / 100; 
